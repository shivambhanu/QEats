...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    assertEquals(5.0, (double) servingRadiusInKms.getValue());
  }
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    List<Restaurant> restaurantList1 = new ArrayList<>(Arrays.asList(restaurant1, restaurant4));  //insert restaurant1 and restaurant4
    List<Restaurant> restaurantList2 = new ArrayList<>(Arrays.asList(restaurant2, restaurant4));  //insert restaurant2 and restaurant4
