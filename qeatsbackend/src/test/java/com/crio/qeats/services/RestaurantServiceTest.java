...
class RestaurantServiceTest {
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    LocalTime timeOfService = LocalTime.of(22, 0);
    
    when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(any(Double.class), any(Double.class), any(LocalTime.class), any(Double.class))).thenReturn(expRestaurants);

    GetRestaurantsResponse allRestaurantsCloseBy = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.0), timeOfService);
    ...
    verify(restaurantRepositoryServiceMock, times(1)).findAllRestaurantsCloseBy(any(Double.class), any(Double.class), any(LocalTime.class), any(Double.class));
  }
